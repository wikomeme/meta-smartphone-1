...
adbd_SRC_FILES += adb.cpp
adbd_SRC_FILES += fdevent.cpp
adbd_SRC_FILES += transport.cpp
adbd_SRC_FILES += transport_local.cpp
adbd_SRC_FILES += transport_usb.cpp
adbd_SRC_FILES += adb_auth_client.cpp
adbd_SRC_FILES += sockets.cpp
adbd_SRC_FILES += services.cpp
adbd_SRC_FILES += file_sync_service.cpp
adbd_SRC_FILES += jdwp_service.cpp
adbd_SRC_FILES += framebuffer_service.cpp
adbd_SRC_FILES += remount_service.cpp
adbd_SRC_FILES += disable_verity_service.cpp
adbd_SRC_FILES += base64.cpp
adbd_SRC_FILES += usb_linux_client.cpp
