...
adb_SRC_FILES += adb.cpp
adb_SRC_FILES += console.cpp
adb_SRC_FILES += transport.cpp
adb_SRC_FILES += transport_local.cpp
adb_SRC_FILES += transport_usb.cpp
adb_SRC_FILES += commandline.cpp
adb_SRC_FILES += adb_client.cpp
adb_SRC_FILES += adb_auth_host.cpp
adb_SRC_FILES += sockets.cpp
adb_SRC_FILES += services.cpp
adb_SRC_FILES += file_sync_client.cpp
adb_SRC_FILES += get_my_path_linux.cpp
adb_SRC_FILES += usb_linux.cpp
adb_SRC_FILES += usb_vendors.cpp
adb_SRC_FILES += fdevent.cpp
