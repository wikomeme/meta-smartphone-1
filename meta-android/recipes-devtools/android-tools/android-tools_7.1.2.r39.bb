...
# matches with android-7.1.2_r39
SRCREV_core = "c9c6522ae83160d0ee16b7bf67e046908b91a890"
SRCREV_extras = "2b7e5d083e92f3b0bfe916a650c91176ddaa2d2b"
SRCREV_libhardware = "abf5cb158650c247576b02648b10a11918e80972"
SRCREV_libselinux = "d5510de4340291241ff5940df9f93d3a2e15c5df"
SRCREV_build = "d613c0a5f21e7e89e8b3bb2f35f217241f866631"
...
SRC_URI = " \
    ...
    file://core/0002-adb-define-shell-command.patch;patchdir=system/core \
    file://core/0003-adb-Fix-build-on-big-endian-systems.patch;patchdir=system/core \
    file://core/0004-adb-add-base64-implementation.patch;patchdir=system/core \
    file://core/0005-adb-Musl-fixes.patch;patchdir=system/core \
    file://core/0006-adb-usb_linux.c-fix-build-with-glibc-2.28.patch;patchdir=system/core \
    file://core/0007-adb-Allow-adbd-to-be-ran-as-root.patch;patchdir=system/core \
    file://core/0008-Use-linux-capability.h-on-linux-systems-too.patch;patchdir=system/core \
    file://core/0009-Remove-bionic-specific-calls.patch;patchdir=system/core \
    file://core/0010-Fix-implicit-declaration-of-stlcat-strlcopy-function.patch;patchdir=system/core \
